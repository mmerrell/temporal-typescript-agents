 ...
 * Same as Exercise 3 but with the HITL system prompt that instructs
 * Claude to use ask_user instead of asking questions in plain text.
 */
...
export async function callLLM(
  ...
  tools: Anthropic.Tool[] = TOOLS_HITL
